function [s D]=semblance(t,y1,y2,nscales)
...
% subplot(6,1,2); imagesc(real(c1)); axis xy; axis tight; title('CWT'); ylabel('Wavelength');
% subplot(6,1,3); plot(t,y2); axis tight; title('Data 2'); 
% subplot(6,1,4); imagesc(real(c2)); axis xy; axis tight; title('CWT'); ylabel('Wavelength');
% subplot(6,1,5); imagesc(s,[-1 1]); axis xy; axis tight; title('Semblance'); ylabel('Wavelength'); 
% subplot(6,1,6); imagesc(D,[-1 1]); axis xy; axis tight; title('Dot Product'); ylabel('Wavelength'); 
% 
% colormap(jet(256));
% 
